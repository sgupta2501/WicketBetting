...
#Over_of_last_wicket,Over_of_next_wicket,batsman,bowler,non_striker,over,
#tot_wicket_upto_this_over,wicket_in_this_over

#13,16,KL Rahul,Bipul Sharma,AB de Villiers,14, 3,1

#batsman,non_striker,bowler
#KL Rahul,AB de Villiers,Bipul Sharma
